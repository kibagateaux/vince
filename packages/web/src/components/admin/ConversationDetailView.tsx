/**
 * @module @bangui/web/components/admin/ConversationDetailView
...
import { getConversationDetail, injectAdminMessage } from '../../lib/api.js';
...
/**
 * Detailed conversation view with messages and admin controls
 */
export const ConversationDetailView: FC = () => {

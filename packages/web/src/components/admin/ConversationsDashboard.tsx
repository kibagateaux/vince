/**
 * @module @bangui/web/components/admin/ConversationsDashboard
...
import { getConversations, getDashboardStats } from '../../lib/api.js';
 ...
 */
export const ConversationsDashboard: FC = () => {
